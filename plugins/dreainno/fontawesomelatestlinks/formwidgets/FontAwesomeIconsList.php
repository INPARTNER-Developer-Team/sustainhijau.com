...
namespace Dreainno\FontAwesomeLatestLinks\FormWidgets;
 ...
 */
class FontAwesomeIconsList extends FormWidgetBase
{
    const DEFAULT_ALIAS = 'fontawesomeiconslist';
    ...
    public function render()
    {
        ...
        return $this->makePartial('fontawesomeiconslist');
    }
    ...
    public function loadAssets()
    {
        ...
        $this->addCss('css/fontawesomeiconslist.css');
    }
